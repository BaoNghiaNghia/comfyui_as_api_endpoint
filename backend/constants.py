...
INIT_REQUEST = [
    ...
    # {
    #     "short_description": [
    #         "A confident man in a leather jacket with headphones under a glowing sunset and abstract soundwaves",
    #         "A cheerful woman with pastel hair, futuristic sunglasses, and headphones against a dreamy pink and mint sky",
    #         "A focused man in a black turtleneck with neon lighting in a dark industrial setting",
    #         "A serene woman with silver headphones in a cosmic nebula backdrop",
    #         "A dynamic man in a red bomber jacket with headphones at an EDM festival stage with fireworks",
    #         "A bold woman with neon headphones in a futuristic cityscape filled with glowing signs",
    #         "A tough man in a leather jacket with headphones at a dark festival stage with red lights",
    #         "An intense man with cybernetic implants and sleek headphones in a neon-lit futuristic alley",
    #         "A muscular man in armor-like headphones at a festival stage with lasers and pyrotechnics",
    #         "A bold woman in streetwear with headphones in an urban setting with colorful street art",
    #     ],
    #     "title": "",
    #     "file_name": "edm_music",
    #     "day_of_week": [0,1,2,3,4,5,6],
